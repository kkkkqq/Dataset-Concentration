...
def main_worker(args):
    ...
    teacher_model = torch.nn.DataParallel(teacher_model, list(range(torch.cuda.device_count())))
    student_model = torch.nn.DataParallel(student_model, list(range(torch.cuda.device_count())))
